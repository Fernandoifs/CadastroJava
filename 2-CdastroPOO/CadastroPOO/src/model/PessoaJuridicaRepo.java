...
public class PessoaJuridicaRepo {
    ...
    public void persistir(String arquivo) throws IOException {
        try (FileOutputStream fileOut = new FileOutputStream(arquivo); ObjectOutputStream objectOut = new ObjectOutputStream(fileOut)) {
    ...
    public void recuperar(String arquivo) throws IOException, ClassNotFoundException {
        try (FileInputStream fileIn = new FileInputStream(arquivo); ObjectInputStream objectIn = new ObjectInputStream(fileIn)) {
